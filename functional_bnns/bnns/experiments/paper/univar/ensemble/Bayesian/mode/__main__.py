...
if len(list_of_json_files)==0: raise OSError(f"Unable to Locate any .json files in directory {master_folder}. This is likely because `__main__.py` was not run in that folder.")
