...
hyperparameter_template = {
	...
	"EARLY_STOPPING": True,
	#
	# ~~~ Try to stop early if converged (a negative delta and large patience promotes stopping once stable, instead of stopping once overfit)
	"DELTA": IT_DEPENDS,
	"PATIENCE": IT_DEPENDS,
	"STRIDE": 20,
	"N_MC_SAMPLES": 1,
...
ARCHITECTURE = [
        ...
        "univar_BNN.univar_BNN_300_300_300",    # ~~~ 3 hidden layers, 300 neurons each
        "univar_BNN.univar_BNN_1000_1000_1000", # ~~~ 3 hidden layers, 1000 neurons each
...
CONDITIONAL_STD = np.concatenate([
        np.geomspace( 1e-4, 1e-2, 9 ),  # ~~~ a grid
