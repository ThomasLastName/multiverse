...
## Missing Features
 ...
 - **More Efficient Implementaiton of Non-Linear Traininable Layers:** This is probably the most egregious missing feature, at the moment. If your architecture has a `Conv2d` layer, or other trainable layer that isn't `nn.Linear`, then the code will be somewhat slow in half of cases, in simply work if using one of the classes `MixturePrior2015BNN`, `SteinEnsemble`, or `SequentialSteinEnsemble`.
